...
Enemy3::Enemy3(float x, float y, float z, color_t color) {
    ...
    static const GLfloat vertex_buffer_data[] = {
        -3.0f,-5.0f,-0.5f, //triangle 1 : begin
        -3.0f,-5.0f, 0.5f,
        -3.0f, 5.0f, 0.5f,//triangle 1 : end
        3.0f, 5.0f,-0.5f, //triangle 2 : begin
        -3.0f,-5.0f,-0.5f,
        -3.0f, 5.0f,-0.5f, //triangle 2 : end
        3.0f,-5.0f, 0.5f,
        -3.0f,-5.0f,-0.5f,
        3.0f,-5.0f,-0.5f,
        3.0f, 5.0f,-0.5f,
...
bounding_box_t Enemy3::bounding_box() {
    ...
    bounding_box_t bbox = { x, y, z, 3.0, 3.0, 3.0 };
    return bbox;
}